    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <a href="/prolongation" style="margin-left: 20px;">
        ...
        <section class="content py-4">
            <div class="container mx-auto px-4">
                ...
                <form action="{{route('updateProl')}}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf 
                    @method('put')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label for="nom" class="block text-sm font-medium text-gray-700  ">Nom:</label>
                            <input type="text" name="nom" id="nom" value="{{$data->stagiaire->nom}}" disabled class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <input type="hidden" name="id_stag" value="{{$data->id_stag}}">
                            <input type="hidden" name="id" value="{{$data->id}}">
                            </div>

                        <div class="mb-4">
                            <label for="prenom" class="block text-sm font-medium text-gray-700">Prénom:</label>
                            <input type="text" name="prenom" id="prenom" value="{{$data->stagiaire->prenom}}" disabled class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="" id="" value="{{$data->old_date_fin}}" disabled class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <input type="hidden" name="date_fin_old" id="date_fin_old" value="{{$data->old_date_fin}}" class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">

                        </div>
                        <div class="mb-4">
                            <label for="id_dep_search" class="block text-sm font-medium text-gray-700">Département d'accueil:</label>
                                <input type="text" id="id_dep_search" class="form-control mb-2" @if(isset($data->id_enc)) value="{{$data->encadrant->departement->nom}}" @endif placeholder="Search..." list="departementsList" autocomplete="off">
                        ...
                        <div class="mb-4">
                            <label for="id_enc_search" class="block text-sm font-medium text-gray-700">Encadrant:</label>
                                <input type="text" id="id_enc_search" class="form-control mb-2" @if(isset($data->id_enc)) value="{{$data->encadrant->nom." ".$data->encadrant->prenom}}" @endif placeholder="Search..." list="encadrantsList" autocomplete="off">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="id_pers_search" class="form-control mb-2" @if(isset($data->id_pers)) value="{{$data->personnel->encadrant->nom." ".$data->personnel->encadrant->prenom}}" @endif placeholder="Search..." list="encadrantsList2" autocomplete="off">
                            ...
                            <input type="hidden" name="old_pers" value="{{$data->stagiaire->personnel->id}}">
                        </div>

                        <div class="mb-4">
                            <label for="date_fin" class="block text-sm font-medium text-gray-700">Nouveau date de fin:</label>
                            <input type="date" name="date_fin" id="date_fin" value="{{$data->date_fin}}" required onchange="calculateDuration()" class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        </div>

                        <div class="mb-4">
                            <label for="motif" class="block text-sm font-medium text-gray-700">Motif de prolongation:</label>
                            <textarea name="motif" id="motif" rows="4" value="{{$data->motif}}"  placeholder="Entrez la raison de la prolongation" class="mt-1 px-4 py-2 block w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{$data->motif}}</textarea>
                        </div>
                    </div>
