    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 ">
                        <h1 class="m-0 flex font-playwrite text-shadow">Attestations de stage</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container mx-auto px-4">
                <div class="container mx-auto px-4">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                        <form action="{{route('fiche.searchA')}}" method="post" class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
                            @csrf
                            @method('post')
                        ...
                        <a href="{{ route('fiche.attestation') }}" class="text-blue-500 hover:text-blue-800 mt-3 sm:mt-0 flex items-center space-x-1">
                ...
                @if($data->isEmpty())
                <div > 
                    <p class="text-red font-bold">Aucune attestation n'était trouvé.</p>
                </div>
@else 
                            ...
                            @foreach($data as $post)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 p-4">
                                        <form action="{{route('fiche.delete',$post->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="bg-transparent border-none mx-2" title="Supprimer" onsubmit="return confirmDelete(event)">
