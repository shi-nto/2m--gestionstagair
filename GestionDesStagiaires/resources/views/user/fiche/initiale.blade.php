    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 ">
                        <h1 class="m-0 flex font-playwrite text-shadow">Fiches de stage</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container mx-auto px-4">
                <div class="container mx-auto px-4">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                        <form action="{{route('fiche.searchI')}}" method="post" class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
                            @csrf
                            @method('post')
                        ...
                        <a href="{{ route('fiche.initiale') }}" class="text-blue-500 hover:text-blue-800 mt-3 sm:mt-0 flex items-center space-x-1">
                ...
                @if($data->isEmpty())
                <div > 
                    <p class="text-red font-bold">Aucune fiche initiale n'était trouvé.</p>
                </div>
@else 
