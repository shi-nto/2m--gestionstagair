                            ...
                            @if($item->deleted != 1)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">
                                        <a href="/admin/encedit/{{$item->id}}" title="Editer"> <i class="fas fa-edit fa-lg"></i> </a> 
                                    </td>
                                    <td class="border border-gray-300 px-4 py-2">
                                        <form action="{{route('enc.delete',$item->id)}}" method="POST" onsubmit="return confirmDelete(event)">
                                            @csrf
                                            @method('DELETE')
